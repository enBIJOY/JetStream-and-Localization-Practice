...
@section('title','About Us Page | Rappo')
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="process-block">
                        <img src="{{asset('rappo/images/process/process-1.jpg')}}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="process-block">
                        <img src="{{asset('rappo/images/process/process-2.jpg')}}" alt="" class="img-fluid">
